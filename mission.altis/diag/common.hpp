...
class CB_RscControlsGroup {
	...
	class VScrollBar : CB_RscScrollBar
	{
		width = 0.021;
		autoScrollEnabled = 1;
	};

	class HScrollBar : CB_RscScrollBar
	{
		height = 0.028;
	};
...
class CB_RscControlsGroupNoScrollbars : CB_RscControlsGroup {
...
class CB_RscListNBox
{
	...
	autoScrollDelay = 5;
	autoScrollRewind = 0;
	class ListScrollBar: CB_RscScrollBar{};
	class ScrollBar: CB_RscScrollBar{};
};
...
class CB_RscTextMulti : CB_RscText
{
	linespacing = 1;
	style = 0 + 16 + 0x200;
};

class CB_RscPictureKeepAspect : CB_RscPicture
{
	style = 0x30 + 0x800;
};

class CB_RscStructuredText {
	type = 13;
	style = 0;
	x = 0;
	y = 0;
...
class CB_RscButtonTextOnly : CB_RscButton {
	SizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	colorBackground[] = {1, 1, 1, 0};
...
class CB_RscButtonMenu : CB_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class CB_RscShortcutButtonMain : CB_RscShortcutButton {
	idc = -1;
	style = 0;
	default = 0;
	w = 0.313726;
...
class CB_RscBackground : CB_RscText {
	type = 0;
	IDC = -1;
	style = 512;
	shadow = 0;
...
class CB_RscCombo {
	...
	class ComboScrollBar : CB_RscScrollBar {};
};
...
class CB_RscGearShortcutButton: CB_RscShortcutButton {
	w = 0.039216;
	h = 0.052288;
	style = 2;
	color[] = {1, 1, 1, 1};
	color2[] = {1, 1, 1, 0.850000};
	colorBackground[] = {1, 1, 1, 1};
	colorbackground2[] = {1, 1, 1, 0.850000};
	colorDisabled[] = {1, 1, 1, 0.400000};
...
class CB_RscIGUIShortcutButton: CB_RscShortcutButton {
	w = 0.183825;
	h = "0.0522876 * 	0.7";
	style = 2;
...
class CB_RscLineBreak {
};

class CB_RscIGUIListNBox: CB_RscListNBox {
	style = "0 + 0x10";
	shadow = 2;
	color[] = {1, 1, 1, 1};
	colorText[] = {1, 1, 1, 0.750000};
	...
	colorSelectBackground[] = {1, 1, 1, 1.000000};
	colorSelectBackground2[] = {1, 1, 1, 1.000000};
	period = 0;
	colorBackground[] = {0, 0, 0, 1};
	columns[] = {0.100000, 0.700000, 0.100000, 0.100000};

	class CB_RscScrollBar: CB_RscScrollBar {
	};
};
